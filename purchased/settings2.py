...
INSTALLED_APPS = [
    ...
    'admin_honeypot',
    'django_otp',
    'django_otp.plugins.otp_totp',  # <- if you want email capability.
...
SECRET_KEY = force_bytes(env('SECRET_KEY'))
...
SECURE_PROXY_SSL_HEADER = ('Strict-Transport-Security','https')
...
CELERY_BEAT_SCHEDULE = { # scheduler configuration 
   'Send_mail_to_Client': {
        ...
        'schedule':crontab(hour=13, minute=20), #every 30 seconds it will be called
